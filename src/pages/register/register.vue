  ...
  <div class="register-card">
    ...
    <el-form :model="form" ref="ruleFormRef" :rules="rules" status-icon>
      ...
      <el-form-item  class="item" prop="name">
        <el-input v-model="form.name" placeholder="请输入昵称" size="large"></el-input>
      </el-form-item>
      <el-form-item  class="item" prop="password">
        <el-input v-model="form.password" placeholder="请输入密码" size="large" show-password></el-input>
      </el-form-item>
...
const rules = reactive<FormRules<{ username: string; password: string, }>>({
  ...
  password: [{ required: true, message: '请输入密码', trigger: 'change' },{ validator: validatorUsername, trigger: 'change'}]
})
